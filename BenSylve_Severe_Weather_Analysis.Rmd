...
This analysis is intended to provide an overview of the impact of sever weather events in the United States. Impact was assessed by looking at the impact on population health and economic consequences. Population health was assessed by reviewing the number of fatalities per weather event type while economic consequences was assessed by reviewing the combined property and crop damage cost. The top 10 event types for number of fatalities and economic consequences since the year 2000 are provided in the figures to follow. More recent data was chosen to reflect more recent weather patterns and to take advantage of the completeness of recent data sets.
...
ggplot(data=stormDataSummaryTopDollars, aes(x=reorder(EVTYPE, DAMAGE), y=DAMAGE), group=1) + labs(x="Event Type", y="Economic Damage (Billions Dollars)") + geom_bar(stat="identity") + coord_flip() + scale_y_continuous(labels=comma) + ggtitle("Severe Weather Event Economic Consequences \n Top 10 Events by Combined Property and Crop Damage")
```